...
`)+`
`+m);const M=v+p+a,y=v+m+o,A=Ru(i,i.VERTEX_SHADER,M),E=Ru(i,i.FRAGMENT_SHADER,y);i.attachShader(g,A),i.attachShader(g,E),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function R(C){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(g)||"",z=i.getShaderInfoLog(A)||"",F=i.getShaderInfoLog(E)||"",D=I.trim(),N=z.trim(),k=F.trim();let j=!0,$=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(j=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,A,E);else{const ee=Pu(i,A,"vertex"),me=Pu(i,E,"fragment");Ee("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
